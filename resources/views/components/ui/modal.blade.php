<div target="{{ $target }}" class="absolute game_modal-holder hidden">
    <div target="{{ $target }}" class="game_modal-overlay fixed top-0 h-screen w-screen bg-gray-400 opacity-50">
    </div>
    <div target="{{ $target }}" class="game_modal-content fixed flex flex-col w-full h-full justify-center">
        <div class="flex flex-row w-full justify-center">
            <div class="w-2/4 bg-gray-200 mt-4 shadow-md">
                <div class="game_modal-header bg-gray-300 w-full px-4 py-4">
                </div>
